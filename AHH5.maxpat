...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 44.740526943206788, 581.63629978895176, 74.0, 23.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 720.405646362304651, 634.435003991127019, 127.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 720.405646362304651, 663.265850677490221, 167.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 938.100000000000023, 140.819999999999993, 127.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1044.085544011592901, 803.754742026329041, 151.470594525337219, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 865.722960493564642, 803.584988303184673, 151.470594525337219, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 48.095257396698088, 636.731411874294281, 29.5, 23.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 48.095257396698088, 668.645529980659489, 94.0, 23.0 ],
					"text" : "prepend scale"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 361.165343189239366, 857.517189583778418, 61.0, 23.0 ],
					"text" : "mc.pack~"
				}
...
,
					...
					"patching_rect" : [ 1575.700000000000045, 1234.259999999999991, 121.0, 23.0 ],
					"text" : "mc.gen~ @title pp",
					"wrapper_uniquekey" : "u190000450"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 150.643278083801334, 926.57375060796744, 29.5, 23.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 150.642689578533236, 883.706103377342288, 74.0, 23.0 ],
					"text" : "clip 0. 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 150.642689578533236, 853.225389108657964, 48.0, 23.0 ],
					"text" : "* 100."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 290.4289721775055, 928.869503669738833, 61.0, 23.0 ],
					"text" : "sig~ 3.7"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 826.830286524295843, 242.861873686313629, 28.0, 23.0 ],
					"text" : "t b"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 594.200640988349733, 1359.531054805517215, 296.984347581863403, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 356.622826278209686, 1454.813785768747266, 41.0, 23.0 ],
					"text" : "mc.*~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 397.263942654132791, 1359.531054805517215, 88.0, 23.0 ],
					"text" : "loadmess 120"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1334.705893814563751, 1272.882353186607361, 150.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 220.538893275260932, 928.869503669738833, 48.0, 23.0 ],
					"text" : "sig~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 356.622826278209686, 1154.491748194694537, 41.0, 23.0 ],
					"text" : "mc.*~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 150.642689578533236, 823.642055884599813, 74.0, 23.0 ],
					"text" : "r noiseamt"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 638.013765602111675, 640.963686859607719, 55.0, 23.0 ],
					"text" : "s start"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 571.779999999999859, 539.374395072460175, 74.0, 23.0 ],
					"text" : "loadmess 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 571.779999999999859, 640.963686859607719, 61.0, 23.0 ],
					"text" : "start $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 28.305448114871979, 548.19336340427401, 94.0, 23.0 ],
					"text" : "send lforange"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 599.264008131027254, 496.237140834331512, 68.0, 23.0 ],
					"text" : "send size"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 28.305448114871979, 393.065306782722473, 81.0, 23.0 ],
					"text" : "loadmess 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 528.244206101894406, 406.226795518398262, 94.0, 23.0 ],
					"text" : "loadmess 0.15"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 528.244206101894406, 496.237140834331512, 55.0, 23.0 ],
					"text" : "size $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 69.961502075195312, 502.32107017040255, 81.0, 23.0 ],
					"text" : "lforange $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 440.044225180149056, 159.92357812047004, 74.0, 23.0 ],
					"text" : "random 200"
				}
